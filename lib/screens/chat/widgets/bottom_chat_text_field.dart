...
class _BottomChatTextFieldState extends ConsumerState<BottomChatTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          if (!isShowReplyMessage)  ReplyMessagePreview(receiverUsername: widget.receiverUsername,),
          Row(
            children: [
              Expanded(
                child: Container(
  ...
  void _sendFile(File file, MessageType messageType) {
    ref.watch(chatControllerProvider).sendFileMessage(
          ...
          groupId: widget.isGroupChat ? widget.receiverUsername : null,
          isGroupChat: widget.isGroupChat,
          isPostTab: widget.isPostTab
        );
  }
